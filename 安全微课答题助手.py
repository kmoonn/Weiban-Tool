...
if __name__ == '__main__':
    # 运行之前一定填写好下面的参数
    userId = '55d75d3c-3464-4f19-ba1f-23c70fdbdfa4'  # 用户ID
    x_token = '205fbb16-1699-49d5-9186-17d15a6e1401'  # 校验
    examPlanId = 'a89a376c-20ce-4cb3-9b75-5cb563ca0534'  # 考试项目ID

    userExamId = 'dbea8ab9-effb-4314-bf0c-dab235b794e9'  # 已完成考试ID
    userExamPlanId = '15f62567-8014-4f3b-b048-b3ec8f27961d'  # 开始考试后当前考试ID
